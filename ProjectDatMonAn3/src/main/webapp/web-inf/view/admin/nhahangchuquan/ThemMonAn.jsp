    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
           <form:form action="/adminnhahangchuquan/themmonannhahang" method="post" class="form-horizontal" modelAttribute="monan">
            <div class="control-group">
              <label class="control-label">tên món ăn :</label>
              <div class="controls">
                <form:input type="text" class="span11" placeholder="tên món ăn" path="tenmonan"/>
              </div>
            </div>
               <div class="control-group">
              <label class="control-label">giá :</label>
              <div class="controls">
                <form:input type="text" class="span11" placeholder="giá" path="gia"/>
              </div>
            </div>
               <div class="control-group">
              <label class="control-label">khuyễn mãi :</label>
              <div class="controls">
                <form:input type="text" class="span11" placeholder="khuyễn mãi" path="khuyenmai"/>
              </div>
            </div>
               <div class="control-group">
              <label class="control-label">thông tin :</label>
              <div class="controls">
                <form:input type="text" class="span11" placeholder="thông tin" path="thongtin"/>
              </div>
            </div>
               <div class="control-group">
              <label class="control-label">hình ảnh :</label>
              <div class="controls">
                <form:input type="text" class="span11" placeholder="hình ảnh" path="hinhanh"/>
              </div>
            </div>
