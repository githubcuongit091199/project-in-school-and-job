    ...
    <div class="span6">
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>chỉnh sửa khuyễn mãi</h5>
        </div>
        <div class="widget-content nopadding">
          <form:form action="/admin/chinhsuakhuyenmai/${GiamGia.iddiscount }" method="post" class="form-horizontal" modelAttribute="GiamGia">
            <div class="control-group">
              <label class="control-label">mã khuyễn mãi :</label>
              <div class="controls">
                <form:input type="text" class="span11" placeholder="${khuyenmai.tenma } " path="tenma"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">số tiền giảm :</label>
              <div class="controls">
                <form:input type="text" class="span11" placeholder="${khuyenmai.money }" path="money"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">ngày bắt đầu :</label>
              <div class="controls">
                <form:input type="text" class="span11" placeholder="${khuyenmai.startdate }" path="startdate"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">ngày kết thúc :</label>
              <div class="controls">
                <form:input type="text" class="span11" placeholder="${khuyenmai.finishdate }" path="finishdate"/>
              </div>
            </div>
